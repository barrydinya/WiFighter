...
- Clean **Home Screen** with live battery %, status, and entry counts
- Full **Main Menu** (button driven)
- **WiFi Recon** – SSID, BSSID, RSSI, channel, encryption type
- **BLE Recon** – name, MAC, RSSI, manufacturer data preview
- **Hybrid Scan** – sequential WiFi + BLE in one pass
- Scrollable detailed result views
- **Settings** screen (scan duration, brightness) with NVS persistence
- Clear data option
- Power-aware UI
...
**v0.2** – Home screen, Menu, WiFi/BLE/Hybrid scanners, Settings with persistence, and solid navigation are complete and usable in the field for authorized work.
