...
- Polished **Home Screen** with clearer layout, live battery, status, WiFi/BLE/probe/ghost counts, last-scan age, and proximity alert indicator
- Full **Main Menu** (button driven, scrollable with position indicator, improved highlight spacing)
...
- **Proximity Alert** – configurable RSSI threshold; home screen flashes “NEAR!” when a device is closer than the threshold
